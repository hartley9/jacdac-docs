...
function MDXContent(_ref) {
  ...
  }))), "Privacy"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "This web site collects aggregated performance and usage indicators, errors and module information.\nNo personal information is collected; data expires after 31 days."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "When physical device connects to the bus, Jacdac generates a random device identifier for the purpose of analytics. The actual device identifier is never sent to analytics.\nThis random identifier is not stored and will be regenerated when the page reloads or the device reconnects."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "Sensor data is never sent to analytics."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "More about Privacy ", "&", " Cookies at ", (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("a", {
    parentName: "p",
...
//# sourceMappingURL=component---src-pages-privacy-mdx-4774bd924d50bbc62781.js.map