...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setAll(0)\\n    let n = modules.ledPixel1.numPixels()\\n    for(let i = 0; i <= n - 1; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setAll(0)\\n    let n = modules.ledPixel1.numPixels()\\n    for(let i = 0; i <= n - 1; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.36,jacdac-led=github:microsoft/pxt-jacdac/led#v0.6.36,jacdac-led-pixel=github:microsoft/pxt-jacdac/led-pixel#v0.6.36\"},\"type\":\"renderblocks\",\"id\":\"8e04ee570dedb01ff0f2aa55f69893e1\"},\"url\":\"/images/makecode/8e04ee570dedb01ff0f2aa55f69893e1.png\",\"width\":622,\"height\":360}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-ledpixel-mdx-1bd3ce8d2a78e54b88d1.js.map