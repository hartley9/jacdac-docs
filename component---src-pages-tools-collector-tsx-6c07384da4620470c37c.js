...
/* harmony import */ var _jdom_spec__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45656);
...
var HourglassEmpty = __webpack_require__(25252);
...
function DataSetGrid(props) {
  ...
  return /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    container: true,
    spacing: 2
  }, tables.map(table => /*#__PURE__*/react.createElement(Grid/* default */.ZP, Object.assign({
    item: true
  }, gridBreakpoints, {
    key: "result" + table.id
  ...
  }, "Save"), handleDeleteTable && /*#__PURE__*/react.createElement(IconButtonWithTooltip/* default */.Z, {
    title: "delete",
...
function Collector() {
  ...
  (0,react.useEffect)(() => {
    ...
    recordingRegisters.forEach(reg => reg.sendSetPackedAsync([samplingIntervalDelay]));
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h1", null, "Data Collector"), /*#__PURE__*/react.createElement("p", null, "Use this page to collect streaming data from Jacdac devices into various output formats."), !!aggregators.length && /*#__PURE__*/react.createElement("section", {
    id: aggregatorsId
  ...
  }, "data aggregator"), " ", "service collects collects sensor data on the bus and returns an aggregated at regular intervals."), /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    container: true,
    spacing: 1
    ...
    id: recordId
  }, /*#__PURE__*/react.createElement("h3", null, "Record data"), aggregator && /*#__PURE__*/react.createElement("p", null, "Record the sensor input configuration in order to up your ML model later on."), /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    container: true,
    direction: "row",
    spacing: 1
  ...
  }, starting ? countdown + "" : recording ? "Stop" : "Start")), aggregator && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true
  }, /*#__PURE__*/react.createElement(Button/* default */.Z, {
    variant: "contained",
...
//# sourceMappingURL=component---src-pages-tools-collector-tsx-6c07384da4620470c37c.js.map