...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"basic.forever(() => {\\n    plot(modules.joystick1.x(), modules.joystick1.y())\\n})\\n\\nfunction plot(x: number, y: number) {\\n        basic.clearScreen();\\n        let dispX = 2;\\n        let dispY = 2;\\n        if (x < -30)\\n            dispX--;\\n        if (x < -60)\\n            dispX--;\\n        if (x > 30)\\n            dispX++;\\n        if (x > 60)\\n            dispX++;\\n        if (y < -30)\\n            dispY--;\\n        if (y < -60)\\n            dispY--;\\n        if (y > 30)\\n            dispY++;\\n        if (y > 60)\\n            dispY++;\\n        led.plot(dispX, dispY);\\n}\\n\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    plot(modules.joystick1.x(), modules.joystick1.y())\\n})\\n\\nfunction plot(x: number, y: number) {\\n        basic.clearScreen();\\n        let dispX = 2;\\n        let dispY = 2;\\n        if (x < -30)\\n            dispX--;\\n        if (x < -60)\\n            dispX--;\\n        if (x > 30)\\n            dispX++;\\n        if (x > 60)\\n            dispX++;\\n        if (y < -30)\\n            dispY--;\\n        if (y < -60)\\n            dispY--;\\n        if (y > 30)\\n            dispY++;\\n        if (y > 60)\\n            dispY++;\\n        led.plot(dispX, dispY);\\n}\\n\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-joystick=github:microsoft/pxt-jacdac/joystick#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"cfc279f72c54f7fba547eeee5629b1fd\"},\"url\":\"/images/makecode/cfc279f72c54f7fba547eeee5629b1fd.png\",\"width\":937,\"height\":1382}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "events",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-joystick-mdx-ba3b97fef5d502507d2e.js.map