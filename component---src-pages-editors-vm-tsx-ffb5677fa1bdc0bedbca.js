...
var Cancel = __webpack_require__(44993);
...
function RoleChip(props) {
  ...
  var handleRoleClick = () => {
    ...
    if (workspace) {
      ...
      if (!twinBlock) {
        ...
        var variable = workspace.getVariable(role, (0,servicesbase/* toRoleType */.tT)(service.specification, true));
        if (!variable) variable = workspace.getVariable(role, (0,servicesbase/* toRoleType */.tT)(service.specification, false));
  ...
  return /*#__PURE__*/react.createElement(Chip/* default */.Z, {
    ...
    deleteIcon: /*#__PURE__*/react.createElement(Tooltip/* default */.Z, {
...
var Pause = __webpack_require__(711);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/PlayForWork.js
var PlayForWork = __webpack_require__(31084);
...
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/BugReport.js
var BugReport = __webpack_require__(95257);
...
function VMRunnerButtons(props) {
  ...
  }, paused || stopped ? /*#__PURE__*/react.createElement(PlayArrow/* default */.Z, null) : /*#__PURE__*/react.createElement(Stop/* default */.Z, null)), " "), /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true
  ...
  }, paused ? /*#__PURE__*/react.createElement(PlayForWork/* default */.Z, null) : /*#__PURE__*/react.createElement(Pause/* default */.Z, null))), (pausing || paused) && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true
...
var variablesDsl = {
  ...
  compileExpressionToVM: _ref => {
    ...
    if (type === "variables_get") {
      ...
      var ret = {
        expr: (0,compile/* toMemberExpression */.vf)("$var", variable.toString()),
        errors: []
      };
      return ret;
    }
  ...
  compileCommandToVM: _ref2 => {
    ...
    if (type === "math_change" || type === "variables_set") {
      ...
      return {
        cmd: (0,VMgenerator/* makeVMBase */.IZ)(block, {
          type: "CallExpression",
          arguments: [(0,compile/* toMemberExpression */.vf)("$var", variable.toString()), type === "variables_set" ? expr : {
            type: "BinaryExpression",
            operator: "+",
            left: (0,compile/* toMemberExpression */.vf)("$var", variable.toString()),
            right: expr
          }],
          callee: (0,compile/* toIdentifier */.EB)("writeLocal")
        }),
        errors
      };
    }
...
function VMEditorWithContext() {
  ...
  return /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    ...
    direction: "column",
    spacing: 1
  }, !!fileSystem && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true,
    xs: 12
...
//# sourceMappingURL=component---src-pages-editors-vm-tsx-ffb5677fa1bdc0bedbca.js.map