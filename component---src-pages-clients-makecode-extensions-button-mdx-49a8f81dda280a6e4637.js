...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"rendered\":{\"req\":{\"code\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.15,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.15\"},\"type\":\"renderblocks\",\"id\":\"ddedf7f9b6321ba4ead6b7f346d29cc3\"},\"url\":\"/images/makecode/ddedf7f9b6321ba4ead6b7f346d29cc3.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.15,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.15\"},\"type\":\"renderblocks\",\"id\":\"da740c0c156478812901af3606ff92bf\"},\"url\":\"/images/makecode/da740c0c156478812901af3606ff92bf.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-button-mdx-49a8f81dda280a6e4637.js.map