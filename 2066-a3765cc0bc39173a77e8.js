...
function mutateWithSummary(mutateSpec) {
  var _mutate = items => {
    var mutatedItems = items.map(d => _extends({}, d));

    var _loop2 = function _loop2(key) {
      var mutateSpecValue = mutateSpec[key];
      var mutatedResult = typeof mutateSpecValue === "function" ? mutateSpecValue(mutatedItems) : mutateSpecValue;
      var mutatedVector = (mutatedResult == null ? void 0 : mutatedResult[Symbol.iterator]) && typeof mutatedResult !== "string" ? mutatedResult : items.map(() => mutatedResult);
      var i = -1;

      for (var mutatedItem of mutatedItems) {
...
function roll(width, rollFn, options) {
  ...
  return items => {
    return items.map((_, i) => {
      ...
      var startIndex = Math.max(0, endIndex - width + 1);
      var itemsInWindow = items.slice(startIndex, endIndex + 1);
...
var handlers = {
  ...
  moving_average: props => {
    ...
    return tidy(data, mutateWithSummary({
      [newcolumn]: roll(horizon, mean$1(column), {
        partial: true
      })
    }));
  }
...
/******/ 			return "" + "09ed088d5c7a914b7ee738d21fa5a6d03bb6dd65" + "-" + "6181e704774b681a64eb" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=2066-a3765cc0bc39173a77e8.js.map