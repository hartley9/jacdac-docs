...
function ConnectDialog(props) {
  ...
  return /*#__PURE__*/react.createElement(Dialog/* default */.Z, {
    ...
    onClose: handleClose
  }, "Connect to Wifi"), /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    container: true,
    spacing: 1
...
function DashboardWifi(props) {
  ...
  var {
    0: connectionFailedSsid,
    1: setConnectionFailedSsid
  } = (0,react.useState)("");
  ...
  }, connectionFailedSsid && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true,
    xs: 12
  }, /*#__PURE__*/react.createElement(Alert/* default */.Z, {
    severity: "error"
  }, /*#__PURE__*/react.createElement(AlertTitle/* default */.Z, null, "Connection failed"), "Failed to connect to ", connectionFailedSsid, ".")), server && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true,
    xs: 12
  }, /*#__PURE__*/react.createElement(Alert/* default */.Z, {
    severity: "warning"
...
//# sourceMappingURL=1023-a8fd5d4da6d214019f96.js.map