...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.36,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.6.36\"},\"type\":\"renderblocks\",\"id\":\"7da2ef9418336b19a87d51a7a87d44a1\"},\"url\":\"/images/makecode/7da2ef9418336b19a87d51a7a87d44a1.png\",\"width\":494,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-rotaryencoder-mdx-1a157c73cbed8b673a6d.js.map