...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"basic.forever(function () {\\n    const x = modules.accelerometer1.x() * 100\\n    const y = modules.accelerometer1.y() * 100\\n    basic.clearScreen()\\n    plot(x, y)\\n    basic.pause(100)\\n})\\n\\nfunction plot (x: number, y: number) {\\n    let dispX = 2\\n    let dispY = 2\\n    if (Math.abs(x) > 30) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(x) > 60) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(y) > 30) {\\n        dispY += Math.sign(y)\\n    }\\n    if (Math.abs(y) > 60) {\\n        dispY += Math.sign(y)\\n    }\\n    led.plot(dispX, dispY)\\n}\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function () {\\n    const x = modules.accelerometer1.x() * 100\\n    const y = modules.accelerometer1.y() * 100\\n    basic.clearScreen()\\n    plot(x, y)\\n    basic.pause(100)\\n})\\n\\nfunction plot (x: number, y: number) {\\n    let dispX = 2\\n    let dispY = 2\\n    if (Math.abs(x) > 30) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(x) > 60) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(y) > 30) {\\n        dispY += Math.sign(y)\\n    }\\n    if (Math.abs(y) > 60) {\\n        dispY += Math.sign(y)\\n    }\\n    led.plot(dispX, dispY)\\n}\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.43,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.43\"},\"type\":\"renderblocks\",\"id\":\"f12f2bd84c6f917a5b2c978a7fe896f4\"},\"url\":\"/images/makecode/f12f2bd84c6f917a5b2c978a7fe896f4.png\",\"width\":1089,\"height\":822}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "events",
    "style": {
      "position": "relative"
    }
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.43,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.43\"},\"type\":\"renderblocks\",\"id\":\"69992b51dd01c03d501cc572c94a2c89\"},\"url\":\"/images/makecode/69992b51dd01c03d501cc572c94a2c89.png\",\"width\":270,\"height\":142}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-accelerometer-mdx-168075eb06a6bf0f1279.js.map