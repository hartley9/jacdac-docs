"use strict";
(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[7767],{
...
var ListItemIcon = __webpack_require__(12097);
...
var SignalWifiStatusbarNull = __webpack_require__(25145);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/SignalWifiBad.js
var SignalWifiBad = __webpack_require__(39651);
...
function WiFiPasswordDialog(props) {
  ...
  }, "Enter WiFi password for ", ssid), /*#__PURE__*/react.createElement(DialogContent/* default */.Z, null, /*#__PURE__*/react.createElement(TextField/* default */.Z, {
    id: passwordId,
    value: password,
    label: "Password",
    fullWidth: true,
...
function NetworkListItem(props) {
  ...
  var handleAddNetwork = () => setOpen(true);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(ListItem/* default */.ZP, {
    secondaryAction: !known ? /*#__PURE__*/react.createElement(IconButtonWithTooltip/* default */.Z, {
      color: "primary",
      disabled: !!connectError,
      onClick: handleAddNetwork,
      title: "connect"
    }, /*#__PURE__*/react.createElement(Add/* default */.Z, null)) : /*#__PURE__*/react.createElement(CmdButton/* default */.Z, {
      variant: "outlined",
      color: "warning",
      disabled: !!connectError,
  ...
  }, /*#__PURE__*/react.createElement(ListItemIcon/* default */.Z, null, connected ? /*#__PURE__*/react.createElement(Tooltip/* default */.Z, {
    title: "connected"
  }, /*#__PURE__*/react.createElement(Wifi/* default */.Z, null)) : connectionFailed ? /*#__PURE__*/react.createElement(Tooltip/* default */.Z, {
    title: "connection failed"
  }, /*#__PURE__*/react.createElement(SignalWifiBad/* default */.Z, {
    color: "error"
  })) : known && !scanned ? /*#__PURE__*/react.createElement(Tooltip/* default */.Z, {
    title: "not found"
  }, /*#__PURE__*/react.createElement(SignalWifiStatusbarNull/* default */.Z, null)) : null), /*#__PURE__*/react.createElement(ListItemText/* default */.Z, {
    primary: ssid,
    secondary: [known && "priority " + priority, scanned && "RSSI " + rssi + ", channel " + channel, scanFlags && specconstants/* WifiAPFlags.WPS */.GHo.WPS && "WPS"].filter(s => !!s).join(", ")
  ...
  }), open && /*#__PURE__*/react.createElement(WiFiPasswordDialog, {
    service: service,
    open: open,
    setOpen: setOpen,
    ssid: ssid
...
function APList(props) {
  var {
    service,
    connectedSsid
  } = props;
  var scan = (0,react.useCallback)(() => service.sendCmdAsync(specconstants/* WifiCmd.Scan */.kBD.Scan), [service]);
  ...
  (0,useInterval/* default */.Z)(true, scan, aps !== null && aps !== void 0 && aps.length ? 30000 : 10000, [service]);
  ...
  return /*#__PURE__*/react.createElement(List/* default */.Z, null, aps !== undefined && !aps.length && /*#__PURE__*/react.createElement(ListItem/* default */.ZP, null, /*#__PURE__*/react.createElement(Alert/* default */.Z, {
    severity: "success"
  }, "Scanning for networks...")), ssids.map(ssid => /*#__PURE__*/react.createElement(NetworkListItem, {
    key: ssid,
    service: service,
...
function DashboardWifi(props) {
  ...
  }, /*#__PURE__*/react.createElement(Settings/* default */.Z, null)))))), open && /*#__PURE__*/react.createElement(APList, {
    service: service,
    connectedSsid: ssid
  })));
}
...
//# sourceMappingURL=7767-33b2888540d62d046a17.js.map