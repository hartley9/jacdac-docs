...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.37,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.6.37\"},\"type\":\"renderblocks\",\"id\":\"468f4cba8e47dfb951d9a0150b0b5554\"},\"url\":\"/images/makecode/468f4cba8e47dfb951d9a0150b0b5554.png\",\"width\":494,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-rotaryencoder-mdx-8eb08e058aa819e9e628.js.map