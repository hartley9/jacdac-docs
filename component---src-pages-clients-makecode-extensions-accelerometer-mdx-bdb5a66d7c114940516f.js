...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"basic.forever(function() {\\n    let x = modules.accelerometer1.x() * 100\\n    let y = modules.accelerometer1.y() * 100\\n    if (Math.abs(x) > 32) {\\n        basic.showIcon(IconNames.Sad)\\n    } else if (Math.abs(y) > 32) {\\n        basic.showIcon(IconNames.Angry)\\n    } else {\\n        basic.showIcon(IconNames.Happy)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function() {\\n    let x = modules.accelerometer1.x() * 100\\n    let y = modules.accelerometer1.y() * 100\\n    if (Math.abs(x) > 32) {\\n        basic.showIcon(IconNames.Sad)\\n    } else if (Math.abs(y) > 32) {\\n        basic.showIcon(IconNames.Angry)\\n    } else {\\n        basic.showIcon(IconNames.Happy)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.6,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.7.6\"},\"type\":\"renderblocks\",\"id\":\"c5428cf2d8b7cbdcc6542c538c95a0b3\"},\"url\":\"/images/makecode/c5428cf2d8b7cbdcc6542c538c95a0b3.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "events",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-accelerometer-mdx-bdb5a66d7c114940516f.js.map