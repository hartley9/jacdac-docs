...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "p"
  }, "humidity"), " method returns the current humidity."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "As is the case with all sensors, an event handler is supplied for when\nthe sensor value (humidity) changes by a specified amount."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The program below use the two humidity APIs to print\nthe current humidity when it changes by 5 percent:"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("pre", null, (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("code", {
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac,jacdac-humidity=github:microsoft/pxt-jacdac/humidity\"},\"type\":\"renderblocks\",\"id\":\"f673d307e039c25806b967a6dbae6f3a\"},\"url\":\"/images/makecode/f673d307e039c25806b967a6dbae6f3a.png\",\"width\":437,\"height\":128}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-humidity-mdx-f32c59656f347c0ac87e.js.map