...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"basic.forever(() => {\\n    let red = modules.color1.red()\\n    let blue = modules.color1.blue()\\n    let green = modules.color1.green()\\n    if (green > 50 && red + blue < 20) {\\n        led.stopAnimation()\\n        basic.showString(\\\"G\\\")\\n    } else {\\n        basic.clearScreen()\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    let red = modules.color1.red()\\n    let blue = modules.color1.blue()\\n    let green = modules.color1.green()\\n    if (green > 50 && red + blue < 20) {\\n        led.stopAnimation()\\n        basic.showString(\\\"G\\\")\\n    } else {\\n        basic.clearScreen()\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.18,jacdac-color=github:microsoft/pxt-jacdac/color#v0.7.18\"},\"type\":\"renderblocks\",\"id\":\"7b70d5cffe517f746594459d2897d4eb\"},\"url\":\"/images/makecode/7b70d5cffe517f746594459d2897d4eb.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-color-mdx-0764ec370f3a3c0e9cfc.js.map