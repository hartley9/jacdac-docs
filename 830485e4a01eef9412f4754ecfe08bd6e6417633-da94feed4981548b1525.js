...
var StyledSection = (0,styled/* default */.ZP)("section")(_ref => {
  var {
    theme
  } = _ref;
  return {
...
var Devices = __webpack_require__(81067);
...
function SimulateDeviceHint() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, "Simulate", /*#__PURE__*/react.createElement(IconButtonWithTooltip/* default */.Z, {
    ...
    onClick: handleStartSimulator(constants/* SRV_TEMPERATURE */.ToE),
    title: "thermometer",
    ...
    onClick: handleStartSimulator(constants/* SRV_GAMEPAD */.fNW),
    title: "joystick",
...
function Dashboard(props) {
  ...
  var [simulators, physicals] = (0,utils/* splitFilter */.ap)(devices, d => !!bus.findServiceProvider(d.deviceId) || isHostedSimulator(d.deviceId));
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(MakeCodeAddBlocksButton, null), !hideSimulators && /*#__PURE__*/react.createElement(DeviceGroup, Object.assign({
    title: "Simulators",
    ...
    devices: simulators
  }, other), showStartSimulators && !(simulators !== null && simulators !== void 0 && simulators.length) && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true,
    xs: 12
    ...
    devices: physicals
  }, other), /*#__PURE__*/react.createElement(FirmwareAlert, null), showConnect && !physicals.length && /*#__PURE__*/react.createElement(Grid/* default */.ZP, {
    item: true,
    xs: 12
...
//# sourceMappingURL=830485e4a01eef9412f4754ecfe08bd6e6417633-da94feed4981548b1525.js.map