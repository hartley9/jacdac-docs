...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"basic.forever(function() {\\n    let x = modules.accelerometer1.x() * 100\\n    let y = modules.accelerometer1.y() * 100\\n    if (Math.abs(x) > 32) {\\n        basic.showIcon(IconNames.Sad)        \\n    } else if (Math.abs(y) > 32) {\\n        basic.showIcon(IconNames.Angry)        \\n    } else {\\n        basic.showIcon(IconNames.Happy)        \\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function() {\\n    let x = modules.accelerometer1.x() * 100\\n    let y = modules.accelerometer1.y() * 100\\n    if (Math.abs(x) > 32) {\\n        basic.showIcon(IconNames.Sad)        \\n    } else if (Math.abs(y) > 32) {\\n        basic.showIcon(IconNames.Angry)        \\n    } else {\\n        basic.showIcon(IconNames.Happy)        \\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"a63e7172262db3677bb9f116da3ac2dd\"},\"url\":\"/images/makecode/a63e7172262db3677bb9f116da3ac2dd.png\",\"width\":580,\"height\":586}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "events",
    "style": {
      "position": "relative"
    }
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.accelerometer1.onTiltUp(() => {\\n    basic.showArrow(ArrowNames.North)\\n})\\n\\nmodules.accelerometer1.onTiltDown(() => {\\n    basic.showArrow(ArrowNames.South)\\n})\\n\\nmodules.accelerometer1.onTiltLeft(() => {\\n    basic.showArrow(ArrowNames.West)\\n})\\n\\nmodules.accelerometer1.onTiltRight(() => {\\n    basic.showArrow(ArrowNames.East)\\n})\\n\\nmodules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.accelerometer1.onTiltUp(() => {\\n    basic.showArrow(ArrowNames.North)\\n})\\n\\nmodules.accelerometer1.onTiltDown(() => {\\n    basic.showArrow(ArrowNames.South)\\n})\\n\\nmodules.accelerometer1.onTiltLeft(() => {\\n    basic.showArrow(ArrowNames.West)\\n})\\n\\nmodules.accelerometer1.onTiltRight(() => {\\n    basic.showArrow(ArrowNames.East)\\n})\\n\\nmodules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"aafe22c85438a65c42a75006aa791d2b\"},\"url\":\"/images/makecode/aafe22c85438a65c42a75006aa791d2b.png\",\"width\":976,\"height\":315}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-accelerometer-mdx-688b17883b31c9514b4e.js.map