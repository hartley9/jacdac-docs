...
function _convertToSTL() {
  _convertToSTL = (0,asyncToGenerator/* default */.Z)(function* (model, options) {
    ...
    return res === null || res === void 0 ? void 0 : res.stls;
  });
  return _convertToSTL.apply(this, arguments);
}
...
function EnclosureGenerator(props) {
  ...
  var updateUrl = /*#__PURE__*/function () {
    var _ref = (0,asyncToGenerator/* default */.Z)(function* () {
      try {
        ...
        var _files = yield convertToSTL(module, options);
  ...
  }, "Generate STL")), files === null || files === void 0 ? void 0 : files.map(file => /*#__PURE__*/react.createElement(Grid/* default */.Z, Object.assign({
    item: true,
    key: file.name
...
//# sourceMappingURL=4556-def89eea25b09b423624.js.map