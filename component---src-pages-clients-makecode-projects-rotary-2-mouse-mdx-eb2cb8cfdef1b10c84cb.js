...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"rendered\":{\"req\":{\"code\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-hid-mouse=github:microsoft/pxt-jacdac/hid-mouse#v0.7.36,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.7.36\"},\"type\":\"renderblocks\",\"id\":\"241c8b4f4ba6d498df91e308cc5ad1a9\"},\"url\":\"/images/makecode/241c8b4f4ba6d498df91e308cc5ad1a9.png\"}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-projects-rotary-2-mouse-mdx-eb2cb8cfdef1b10c84cb.js.map