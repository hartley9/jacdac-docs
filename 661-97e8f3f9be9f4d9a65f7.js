...
/* harmony import */ var _dashboard_DashboardServiceWidget__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34941);
...
var DEFAULT_HORIZON = 30; // 10 seconds
...
function TwinWidget() {
  ...
  var {
    data,
    setData
  } = (0,_useBlockData__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(sourceBlock, [], 50);
  var currentDataRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)([]); // data collection

  var register = (0,_hooks_useBestRegister__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(twinService);
  ...
  var setRegisterData = () => {
    ...
    if (newValue !== undefined) {
      ...
      var now = bus.timestamp / 1000;
      var rowTime = register.lastDataTimestamp / 1000;
      var outdated = now - DEFAULT_HORIZON;
      var currentData = currentDataRef.current;
      var newData = [].concat((0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)((currentData || []).filter(d => d.time >= outdated)), [_objectSpread({
        time: rowTime
      }, newRow)]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => register === null || register === void 0 ? void 0 : register.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_7__/* .REPORT_UPDATE */ .rGZ, setRegisterData), [register]);
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    currentDataRef.current = data;
  }, [sourceBlock]);
  if (flyout) return null;
  if (!twinService) return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_NoServiceAlert__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, null);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .ZP, {
    container: true,
    alignItems: "center",
    alignContent: "center",
    justifyContent: "center",
    spacing: 1
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .ZP, {
    item: true
...
//# sourceMappingURL=661-97e8f3f9be9f4d9a65f7.js.map