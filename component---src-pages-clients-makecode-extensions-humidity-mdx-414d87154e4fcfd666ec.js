...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.36,jacdac-humidity=github:microsoft/pxt-jacdac/humidity#v0.6.36\"},\"type\":\"renderblocks\",\"id\":\"a69220c652111105a43bdeac5a09c03a\"},\"url\":\"/images/makecode/a69220c652111105a43bdeac5a09c03a.png\",\"width\":437,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-humidity-mdx-414d87154e4fcfd666ec.js.map