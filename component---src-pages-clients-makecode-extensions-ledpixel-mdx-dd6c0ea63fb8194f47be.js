...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setAll(0)\\n    let n = modules.ledPixel1.numPixels()\\n    for(let i = 0; i <= n - 1; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setAll(0)\\n    let n = modules.ledPixel1.numPixels()\\n    for(let i = 0; i <= n - 1; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.37,jacdac-led=github:microsoft/pxt-jacdac/led#v0.6.37,jacdac-led-pixel=github:microsoft/pxt-jacdac/led-pixel#v0.6.37\"},\"type\":\"renderblocks\",\"id\":\"942e6d10224268ecacbae4145812a938\"},\"url\":\"/images/makecode/942e6d10224268ecacbae4145812a938.png\",\"width\":622,\"height\":360}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-ledpixel-mdx-dd6c0ea63fb8194f47be.js.map