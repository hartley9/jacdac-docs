...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"rendered\":{\"req\":{\"code\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-hid-mouse=github:microsoft/pxt-jacdac/hid-mouse#v0.7.36,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.7.36\"},\"type\":\"renderblocks\",\"id\":\"598599f6f7e670e17afb48746dd035f5\"},\"url\":\"/images/makecode/598599f6f7e670e17afb48746dd035f5.png\"}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-projects-rotary-2-mouse-mdx-31e8cd3f3ddb96e69ed2.js.map