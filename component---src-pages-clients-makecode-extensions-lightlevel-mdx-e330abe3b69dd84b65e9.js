...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "p"
  }, "lightLevel"), " method returns the current light level."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The following program outputs the light level when the sensor\nis first connected and whenever the light level changes by 5:"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("pre", null, (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("code", {
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.lightLevel1.onConnected(() => {\\n    basic.showNumber(modules.lightLevel1.lightLevel())\\n})\\n\\nmodules.lightLevel1.onLightLevelChangedBy(5, () => {\\n    basic.showNumber(modules.lightLevel1.lightLevel())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.lightLevel1.onConnected(() => {\\n    basic.showNumber(modules.lightLevel1.lightLevel())\\n})\\n\\nmodules.lightLevel1.onLightLevelChangedBy(5, () => {\\n    basic.showNumber(modules.lightLevel1.lightLevel())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.33,jacdac-light-level=github:microsoft/pxt-jacdac/light-level#v0.6.33\"},\"type\":\"renderblocks\",\"id\":\"6f45d08eca2450a3e30dbb0704ecd78d\"},\"url\":\"/images/makecode/6f45d08eca2450a3e30dbb0704ecd78d.png\",\"width\":1034,\"height\":128}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-lightlevel-mdx-e330abe3b69dd84b65e9.js.map