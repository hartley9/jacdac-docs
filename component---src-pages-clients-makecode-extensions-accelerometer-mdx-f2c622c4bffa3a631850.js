...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "tr",
    "align": null
  }, "0")))), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The following program uses the 'x' and 'y' forces to control the position\nof an LED on the micro:bit's 5x5 LED matrix:"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("pre", null, (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("code", {
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(function () {\\n    const x = modules.accelerometer1.x() * 100\\n    const y = modules.accelerometer1.y() * 100\\n    basic.clearScreen()\\n    plot(x, y)\\n    basic.pause(100)\\n})\\n\\nfunction plot (x: number, y: number) {\\n    let dispX = 2\\n    let dispY = 2\\n    if (Math.abs(x) > 30) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(x) > 60) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(y) > 30) {\\n        dispY += Math.sign(y)\\n    }\\n    if (Math.abs(y) > 60) {\\n        dispY += Math.sign(y)\\n    }\\n    led.plot(dispX, dispY)\\n}\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function () {\\n    const x = modules.accelerometer1.x() * 100\\n    const y = modules.accelerometer1.y() * 100\\n    basic.clearScreen()\\n    plot(x, y)\\n    basic.pause(100)\\n})\\n\\nfunction plot (x: number, y: number) {\\n    let dispX = 2\\n    let dispY = 2\\n    if (Math.abs(x) > 30) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(x) > 60) {\\n        dispX += Math.sign(x)\\n    }\\n    if (Math.abs(y) > 30) {\\n        dispY += Math.sign(y)\\n    }\\n    if (Math.abs(y) > 60) {\\n        dispY += Math.sign(y)\\n    }\\n    led.plot(dispX, dispY)\\n}\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.42,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.42\"},\"type\":\"renderblocks\",\"id\":\"a0c1f2e044a7f3bd361e4493f333d161\"},\"url\":\"/images/makecode/a0c1f2e044a7f3bd361e4493f333d161.png\",\"width\":1089,\"height\":822}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "events",
    "style": {
      "position": "relative"
    }
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.accelerometer1.onShake(function () {\\n    basic.showIcon(IconNames.Heart)\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.42,jacdac-accelerometer=github:microsoft/pxt-jacdac/accelerometer#v0.6.42\"},\"type\":\"renderblocks\",\"id\":\"dfaaa2d8e69f2b8c8a4c6f689d05429f\"},\"url\":\"/images/makecode/dfaaa2d8e69f2b8c8a4c6f689d05429f.png\",\"width\":270,\"height\":142}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-accelerometer-mdx-f2c622c4bffa3a631850.js.map