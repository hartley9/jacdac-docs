...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.37,jacdac-humidity=github:microsoft/pxt-jacdac/humidity#v0.6.37\"},\"type\":\"renderblocks\",\"id\":\"2e8353acedfb4a248f1322f6e910cc8c\"},\"url\":\"/images/makecode/2e8353acedfb4a248f1322f6e910cc8c.png\",\"width\":427,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-humidity-mdx-3aa668b082a706ac5e84.js.map