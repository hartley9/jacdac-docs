...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"rendered\":{\"req\":{\"code\":\"let lastposition = 0\\nmodules.rotaryEncoder1.onPositionChangedBy(1, function () {\\n    if (modules.rotaryEncoder1.position() - lastposition < 0) {\\n        modules.hidMouse1.wheel(-1, 0)\\n    } else {\\n        modules.hidMouse1.wheel(1, 0)\\n    }\\n    lastposition = modules.rotaryEncoder1.position()\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-hid-mouse=github:microsoft/pxt-jacdac/hid-mouse#v0.7.33,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.7.33\"},\"type\":\"renderblocks\",\"id\":\"914d5108c8f50651e227d09de7fa0f0d\"},\"url\":\"/images/makecode/914d5108c8f50651e227d09de7fa0f0d.png\"}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-projects-rotary-2-mouse-mdx-a54a7d1e0266f4aa45da.js.map