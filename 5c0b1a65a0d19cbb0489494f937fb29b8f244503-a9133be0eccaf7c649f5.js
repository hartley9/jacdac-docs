(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[3915,5666],{
...
// UNUSED EXPORTS: TMath, addItems, addRows, asc, complete, contains, count, cumsum, debug, deviation, distinct, endsWith, everything, expand, fill, filter, first, fixedOrder, fullJoin, fullSeq, fullSeqDate, fullSeqDateISOString, groupBy, innerJoin, lag, last, lead, leftJoin, map, matches, mean, meanRate, median, mutate, mutateWithSummary, n, nDistinct, negate, numRange, pick, pivotLonger, pivotWider, rate, rename, replaceNully, roll, select, slice, sliceHead, sliceMax, sliceMin, sliceSample, sliceTail, sort, startsWith, sum, summarizeAll, summarizeAt, summarizeIf, tally, total, totalAll, totalAt, totalIf, transmute, variance, vectorSeq, vectorSeqDate, when
...
/* harmony import */ var _jacdac_providerbus__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(24725);
...
var WorkspaceServices = /*#__PURE__*/function (_JDEventSource) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(WorkspaceServices, _JDEventSource);

  function WorkspaceServices() {
    return _JDEventSource.call(this) || this;
  }

  (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(WorkspaceServices, [{
    key: "workspaceJSON",
    get: function get() {
...
var BlockServices = /*#__PURE__*/function (_JDEventSource2) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(BlockServices, _JDEventSource2);
  ...
  (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(BlockServices, [{
    key: "data",
    get: function get() {
      return this._data;
    },
...
function WorkspaceProvider(props) {
  ...
  var resolveServiceId = () => {
    var newSourceBlock = field.getSourceBlock();
    var roleInput = newSourceBlock === null || newSourceBlock === void 0 ? void 0 : newSourceBlock.inputList[0];
    var roleField = roleInput === null || roleInput === void 0 ? void 0 : roleInput.fieldRow.find(f => f.name === "service" && f instanceof blockly__WEBPACK_IMPORTED_MODULE_0__.FieldVariable);

    if (roleField) {
      var _roleField$getVariabl2;

      var xml = document.createElement("xml");
      roleField === null || roleField === void 0 ? void 0 : roleField.toXml(xml);
      var newSensor = roleField === null || roleField === void 0 ? void 0 : (_roleField$getVariabl2 = roleField.getVariable()) === null || _roleField$getVariabl2 === void 0 ? void 0 : _roleField$getVariabl2.getId();
      return newSensor;
    }
  ...
  var resolveTwinService = () => {
    ...
    var newSensorService = serviceId && _jacdac_providerbus__WEBPACK_IMPORTED_MODULE_6__/* ["default"].node */ .Z.node(serviceId);
  ...
  var {
    0: serviceId,
    1: setServiceId
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(resolveServiceId());
  var {
    0: twinService,
    1: setTwinService
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(resolveTwinService());
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    var unsubs = [roleManager === null || roleManager === void 0 ? void 0 : roleManager.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_2__/* .CHANGE */ .Ver, () => setTwinService(resolveTwinService())), _jacdac_providerbus__WEBPACK_IMPORTED_MODULE_6__/* ["default"].subscribe */ .Z.subscribe([_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_2__/* .DEVICE_ANNOUNCE */ .Hob, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_2__/* .DEVICE_DISCONNECT */ .O55], () => setTwinService(resolveTwinService()))];
    return () => unsubs.forEach(unsub => unsub === null || unsub === void 0 ? void 0 : unsub());
...
function createCsvWorker() {
  return typeof Window !== "undefined" && new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(4366), __webpack_require__.b // syntax not supported in typescript
  ));
}
...
function createCadWorker() {
  return typeof Window !== "undefined" && new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(5813), __webpack_require__.b // syntax not supported in typescript
  ));
}
...
/* harmony export */   "pB": function() { return /* binding */ SENSOR_BLOCK; },
/* harmony export */   "FR": function() { return /* binding */ toolsColour; },
/* harmony export */   "cG": function() { return /* binding */ sensorsColour; },
...
var SENSOR_BLOCK = "jacdac_sensors_sensor";
var toolsColour = (0,_dsl_palette__WEBPACK_IMPORTED_MODULE_2__/* .paletteColorByIndex */ .W)(-1);
var sensorsColour = (0,_dsl_palette__WEBPACK_IMPORTED_MODULE_2__/* .paletteColorByIndex */ .W)(0);
var CHART_WIDTH = 468;
...
//# sourceMappingURL=5c0b1a65a0d19cbb0489494f937fb29b8f244503-a9133be0eccaf7c649f5.js.map