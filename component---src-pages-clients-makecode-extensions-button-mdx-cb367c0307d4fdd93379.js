...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"rendered\":{\"req\":{\"code\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.3,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.3\"},\"type\":\"renderblocks\",\"id\":\"9b3133b17455df6c9b1d17b9acb7a938\"},\"url\":\"/images/makecode/9b3133b17455df6c9b1d17b9acb7a938.png\",\"width\":714,\"height\":445}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressed()) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressed()) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.3,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.3\"},\"type\":\"renderblocks\",\"id\":\"fd578cff7c14e4127eaeb998385e0f4c\"},\"url\":\"/images/makecode/fd578cff7c14e4127eaeb998385e0f4c.png\",\"width\":389,\"height\":400}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The lower-level state of the button is accessible via the the ", (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.3,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.3\"},\"type\":\"renderblocks\",\"id\":\"5a09d1291ef77d895e95ba651ddc6767\"},\"url\":\"/images/makecode/5a09d1291ef77d895e95ba651ddc6767.png\",\"width\":599,\"height\":560}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-button-mdx-cb367c0307d4fdd93379.js.map