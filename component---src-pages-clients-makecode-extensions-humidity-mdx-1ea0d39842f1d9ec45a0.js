...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.humidity1.onHumidityChangedBy(5, function() {\\n    led.stopAnimation()\\n    basic.showNumber(modules.humidity1.humidity())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.40,jacdac-humidity=github:microsoft/pxt-jacdac/humidity#v0.6.40\"},\"type\":\"renderblocks\",\"id\":\"7ef8c839bcdb3e34c975e33d799f4704\"},\"url\":\"/images/makecode/7ef8c839bcdb3e34c975e33d799f4704.png\",\"width\":427,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-humidity-mdx-1ea0d39842f1d9ec45a0.js.map