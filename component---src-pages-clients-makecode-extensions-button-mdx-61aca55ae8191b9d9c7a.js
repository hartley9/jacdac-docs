...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"let holdCount = 0\\nmodules.button1.onDown(() => {\\n    holdCount = 0\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(() => {\\n    holdCount++\\n    basic.showNumber(holdCount)\\n})\\nmodules.button1.onUp(() => {\\n    basic.showString(\\\"U\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"let holdCount = 0\\nmodules.button1.onDown(() => {\\n    holdCount = 0\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(() => {\\n    holdCount++\\n    basic.showNumber(holdCount)\\n})\\nmodules.button1.onUp(() => {\\n    basic.showString(\\\"U\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-button=github:microsoft/pxt-jacdac/button#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"3393ad968ad5879b8ef95bb3987484d2\"},\"url\":\"/images/makecode/3393ad968ad5879b8ef95bb3987484d2.png\",\"width\":714,\"height\":349}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressed())\\n        basic.showString(\\\"D\\\")\\n    else\\n        basic.showString(\\\"U\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressed())\\n        basic.showString(\\\"D\\\")\\n    else\\n        basic.showString(\\\"U\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-button=github:microsoft/pxt-jacdac/button#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"2bf34dd0f86a8c143fced7580ede22fe\"},\"url\":\"/images/makecode/2bf34dd0f86a8c143fced7580ede22fe.png\",\"width\":389,\"height\":304}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The lower-level state of the button is accessible via the the ", (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70)\\n        basic.showString(\\\"D\\\")\\n    else if (modules.button1.pressure() === 0)\\n        basic.showString(\\\"U\\\")\\n    else\\n        basic.showString(\\\"x\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70)\\n        basic.showString(\\\"D\\\")\\n    else if (modules.button1.pressure() === 0)\\n        basic.showString(\\\"U\\\")\\n    else\\n        basic.showString(\\\"x\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.45,jacdac-button=github:microsoft/pxt-jacdac/button#v0.6.45\"},\"type\":\"renderblocks\",\"id\":\"02398def4968662908f8ae3e2bdea7c5\"},\"url\":\"/images/makecode/02398def4968662908f8ae3e2bdea7c5.png\",\"width\":599,\"height\":416}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-button-mdx-61aca55ae8191b9d9c7a.js.map