...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"let holdCount = 0\\nmodules.button1.onDown(() => {\\n    holdCount = 0\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(() => {\\n    holdCount++\\n    basic.showNumber(holdCount)\\n})\\nmodules.button1.onUp(() => {\\n    basic.showString(\\\"U\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"let holdCount = 0\\nmodules.button1.onDown(() => {\\n    holdCount = 0\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(() => {\\n    holdCount++\\n    basic.showNumber(holdCount)\\n})\\nmodules.button1.onUp(() => {\\n    basic.showString(\\\"U\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.1,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.1\"},\"type\":\"renderblocks\",\"id\":\"0343e3aaf1b4df56f11ca6b7f25d0e0b\"},\"url\":\"/images/makecode/0343e3aaf1b4df56f11ca6b7f25d0e0b.png\",\"width\":714,\"height\":349}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressed())\\n        basic.showString(\\\"D\\\")\\n    else\\n        basic.showString(\\\"U\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressed())\\n        basic.showString(\\\"D\\\")\\n    else\\n        basic.showString(\\\"U\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.1,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.1\"},\"type\":\"renderblocks\",\"id\":\"45ed8aa891b2334be03411e5b8dd2796\"},\"url\":\"/images/makecode/45ed8aa891b2334be03411e5b8dd2796.png\",\"width\":389,\"height\":304}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The lower-level state of the button is accessible via the the ", (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70)\\n        basic.showString(\\\"D\\\")\\n    else if (modules.button1.pressure() === 0)\\n        basic.showString(\\\"U\\\")\\n    else\\n        basic.showString(\\\"x\\\")\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70)\\n        basic.showString(\\\"D\\\")\\n    else if (modules.button1.pressure() === 0)\\n        basic.showString(\\\"U\\\")\\n    else\\n        basic.showString(\\\"x\\\")\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.1,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.1\"},\"type\":\"renderblocks\",\"id\":\"40bccc458d1e92aba3a6dfba87d84b05\"},\"url\":\"/images/makecode/40bccc458d1e92aba3a6dfba87d84b05.png\",\"width\":599,\"height\":416}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-button-mdx-f68edfc73226095694c5.js.map