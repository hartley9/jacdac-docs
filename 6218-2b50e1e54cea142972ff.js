(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[6218],{
...
var node_modules_debounce = __webpack_require__(62881);
...
function createEvents(store) {
  ...
  function patchIntersects(intersections, event) {
    ...
    if ('pointerId' in event && internal.capturedMap.has(event.pointerId)) {
      for (var captureData of internal.capturedMap.get(event.pointerId).values()) {
      ...
      if (instance.__r3f.primitive && newProps.object && newProps.object !== instance) return [true];else {
        ...
        var {
          ...
          children: cO
            ...
            restOld = (0,objectWithoutProperties/* default */.Z)(oldProps, _excluded5); // Throw if an object or literal was passed for args
...
var react_three_fiber_esm_createStore = (applyProps, _invalidate, _advance, props) => {
  var {
    gl,
    size,
    shadows = false,
  ...
  if (linear) gl.outputEncoding = three_module.LinearEncoding;
  if (flat) gl.toneMapping = three_module.NoToneMapping; // clock.elapsedTime is updated using advance(timestamp)
  ...
  rootState.subscribe(() => {
    ...
    if (size !== oldSize || viewport.dpr !== oldDpr) {
      ...
      if (!camera.manual && !(internal.lastProps.camera instanceof three_module.Camera)) {
        if (isOrthographicCamera(camera)) {
...
var createRendererInstance = (gl, canvas) => {
  ...
  var renderer = new three_module.WebGLRenderer(_objectSpread({
  ...
  renderer.outputEncoding = three_module.sRGBEncoding;
  renderer.toneMapping = three_module.ACESFilmicToneMapping; // Set gl props
...
function render(element, canvas) {
  ...
  if (!fiber) {
    ...
    store = react_three_fiber_esm_createStore(applyProps, invalidate, advance, _objectSpread({
      gl: glRenderer,
      size
    }, props));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ STLModel; }
});

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(67294);
// EXTERNAL MODULE: ./node_modules/@react-three/fiber/dist/react-three-fiber.esm.js + 3 modules
var react_three_fiber_esm = __webpack_require__(80189);
// EXTERNAL MODULE: ./node_modules/three/build/three.module.js
var three_module = __webpack_require__(93456);
...
class STLLoader extends three_module.Loader {
  ...
  parse(data) {
    ...
    function parseASCII(data) {
      ...
      var vertices = [];
      var normals = [];
      var normal = new three_module.Vector3();
      var result;
      var groupCount = 0;
      var startVertex = 0;
      var endVertex = 0;
...
;// CONCATENATED MODULE: ./src/components/home/models/STLModel.tsx
...
function STLModel(props) {
  ...
  var obj = (0,react_three_fiber_esm/* useLoader */.U2)(STLLoader, url);
  return /*#__PURE__*/react.createElement(react.Suspense, {
    fallback: null
  }, /*#__PURE__*/react.createElement("mesh", null, /*#__PURE__*/react.createElement("primitive", {
    object: obj,
    attach: "geometry"
...
//# sourceMappingURL=6218-2b50e1e54cea142972ff.js.map