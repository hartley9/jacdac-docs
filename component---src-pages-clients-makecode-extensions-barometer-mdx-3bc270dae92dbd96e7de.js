...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "p"
  }, "pressure"), " method returns the current barometric pressure."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The following program outputs the pressure when the barometer\nis first connected and then whenever the pressure changes by 0.2 hPa:"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("pre", null, (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("code", {
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.barometer1.onConnected(function() {\\n    basic.showNumber(modules.barometer1.pressure())\\n})\\n\\nmodules.barometer1.onPressureChangedBy(0.2, function() {\\n    basic.showNumber(modules.barometer1.pressure())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.barometer1.onConnected(function() {\\n    basic.showNumber(modules.barometer1.pressure())\\n})\\n\\nmodules.barometer1.onPressureChangedBy(0.2, function() {\\n    basic.showNumber(modules.barometer1.pressure())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.33,jacdac-barometer=github:microsoft/pxt-jacdac/barometer#v0.6.33\"},\"type\":\"renderblocks\",\"id\":\"4374397b17fbf4d06b4ab9065fbb43ba\"},\"url\":\"/images/makecode/4374397b17fbf4d06b4ab9065fbb43ba.png\",\"width\":938,\"height\":128}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-barometer-mdx-3bc270dae92dbd96e7de.js.map