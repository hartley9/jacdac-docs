...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setBrightness(85)\\n    modules.ledPixel1.setAll(0)\\n    let numPixels = modules.ledPixel1.numPixels()\\n    for(let i=0; i<numPixels; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }    \\n})\",\"rendered\":{\"req\":{\"code\":\"modules.ledPixel1.onConnected(() => {\\n    modules.ledPixel1.setBrightness(85)\\n    modules.ledPixel1.setAll(0)\\n    let numPixels = modules.ledPixel1.numPixels()\\n    for(let i=0; i<numPixels; i++) {\\n        modules.ledPixel1.setPixel(i, 0x00ff00)\\n        basic.pause(200)\\n    }    \\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.33,jacdac-led=github:microsoft/pxt-jacdac/led#v0.6.33,jacdac-led-pixel=github:microsoft/pxt-jacdac/led-pixel#v0.6.33\"},\"type\":\"renderblocks\",\"id\":\"280ecdf69c08addd07de94ce417d5b7a\"},\"url\":\"/images/makecode/280ecdf69c08addd07de94ce417d5b7a.png\",\"width\":622,\"height\":408}}\n")));
}
;
