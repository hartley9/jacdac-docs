...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.33,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.6.33\"},\"type\":\"renderblocks\",\"id\":\"04a4086e46733358bbfee9493b19afe0\"},\"url\":\"/images/makecode/04a4086e46733358bbfee9493b19afe0.png\",\"width\":494,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-rotaryencoder-mdx-e3b41b3be63e7bbe20d3.js.map