...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
  ...
  }, "{\"source\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"rendered\":{\"req\":{\"code\":\"let holdCount = 0\\nmodules.button1.onUp(function () {\\n    led.stopAnimation()\\n    basic.showString(\\\"U\\\")\\n})\\nmodules.button1.onDown(function () {\\n    holdCount = 0\\n    led.stopAnimation()\\n    basic.showString(\\\"D\\\")\\n})\\nmodules.button1.onHold(function () {\\n    holdCount += 1\\n    led.stopAnimation()\\n    basic.showNumber(holdCount)\\n})\\n\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.21,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.21\"},\"type\":\"renderblocks\",\"id\":\"21f46038a6648664147aa2d37939b3bd\"},\"url\":\"/images/makecode/21f46038a6648664147aa2d37939b3bd.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    ...
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    if (modules.button1.pressure() >= 70) {\\n        led.stopAnimation()\\n        basic.showString(\\\"D\\\")\\n    } else if (modules.button1.pressure() === 0) {\\n        led.stopAnimation()\\n        basic.showString(\\\"U\\\")\\n    } else {\\n        led.stopAnimation()\\n        basic.showString(\\\"x\\\")\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.21,jacdac-button=github:microsoft/pxt-jacdac/button#v0.7.21\"},\"type\":\"renderblocks\",\"id\":\"0c0e81c0c056fe17394f9b61724a0ee8\"},\"url\":\"/images/makecode/0c0e81c0c056fe17394f9b61724a0ee8.png\"}}\n")), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("h2", {
    "id": "see-also",
    "style": {
      "position": "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-button-mdx-d7aa246c63fbde68ed70.js.map