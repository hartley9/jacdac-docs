...
(function (BridgeReg) {
     ...
     * ```
     */
    BridgeReg[BridgeReg["Enabled"] = 1] = "Enabled";
})(BridgeReg || (BridgeReg = {}));
var ButtonReg;
(function (ButtonReg) {
    /**
...
(function (DistanceReg) {
     ...
     * ```
     */
    DistanceReg[DistanceReg["DistanceError"] = 262] = "DistanceError";
    /**
...
(function (FlexReg) {
     ...
     * ```
     */
    FlexReg[FlexReg["BendingError"] = 262] = "BendingError";
    /**
     ...
     * ```
     */
    FlexReg[FlexReg["Length"] = 384] = "Length";
})(FlexReg || (FlexReg = {}));
var GyroscopeReg;
...
(function (IlluminanceReg) {
     ...
     * ```
     */
    IlluminanceReg[IlluminanceReg["Illuminance"] = 257] = "Illuminance";
    /**
     ...
     * ```
     */
    IlluminanceReg[IlluminanceReg["IlluminanceError"] = 262] = "IlluminanceError";
...
(function (LightBulbReg) {
     ...
     * ```
     */
    LightBulbReg[LightBulbReg["Dimmable"] = 384] = "Dimmable";
...
(function (LightLevelReg) {
     ...
     * ```
     */
    LightLevelReg[LightLevelReg["LightLevelError"] = 262] = "LightLevelError";
    /**
     * Constant Variant (uint8_t). The type of physical sensor.
     *
     * ```
...
(function (MotorReg) {
     ...
     * ```
     */
    MotorReg[MotorReg["Reversible"] = 386] = "Reversible";
})(MotorReg || (MotorReg = {}));
...
(function (SoundPlayerCmd) {
     ...
     */
    SoundPlayerCmd[SoundPlayerCmd["Cancel"] = 129] = "Cancel";
    /**
     ...
     * ```
     */
    SoundPlayerCmd[SoundPlayerCmd["ListSounds"] = 130] = "ListSounds";
...
(function (WaterLevelReg) {
     ...
     * ```
     */
    WaterLevelReg[WaterLevelReg["LevelError"] = 262] = "LevelError";
    /**
     * Constant Variant (uint8_t). The type of physical sensor.
     *
     * ```
