...
function InstallPWAButton(props) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    var _getInstalledRelatedA, _ref;

    if (typeof window === "undefined") return; // eslint-disable-next-line @typescript-eslint/no-explicit-any

    var apps = (_getInstalledRelatedA = (_ref = navigator).getInstalledRelatedApps) === null || _getInstalledRelatedA === void 0 ? void 0 : _getInstalledRelatedA.call(_ref);
  ...
  var onClick = /*#__PURE__*/function () {
    var _ref2 = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(function* (evt) {
      evt.preventDefault();
...
//# sourceMappingURL=8849-8e6f066215576093cad7.js.map