...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.rotaryEncoder1.onPositionChangedBy(1, () => {\\n    led.stopAnimation()\\n    basic.showNumber(modules.rotaryEncoder1.position())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.6.38,jacdac-rotary-encoder=github:microsoft/pxt-jacdac/rotary-encoder#v0.6.38\"},\"type\":\"renderblocks\",\"id\":\"50d8b84d5b81cbe2f1743fb3cb37c153\"},\"url\":\"/images/makecode/50d8b84d5b81cbe2f1743fb3cb37c153.png\",\"width\":494,\"height\":176}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-rotaryencoder-mdx-f0fa2e68d0aa5c49834d.js.map