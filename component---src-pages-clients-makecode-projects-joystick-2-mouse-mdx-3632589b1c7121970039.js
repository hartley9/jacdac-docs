...
function MDXContent(_ref) {
  ...
  }, "{\"source\":\"basic.forever(function () {\\n    let dx = modules.joystick1.x()\\n    let dy = modules.joystick1.y()\\n    if (Math.abs(dx) > 20 || Math.abs(dy) > 20) {\\n        modules.hidMouse1.move(dx / 4, dy / 4)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function () {\\n    let dx = modules.joystick1.x()\\n    let dy = modules.joystick1.y()\\n    if (Math.abs(dx) > 20 || Math.abs(dy) > 20) {\\n        modules.hidMouse1.move(dx / 4, dy / 4)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac#v0.7.26,jacdac-hid-mouse=github:microsoft/pxt-jacdac/hid-mouse#v0.7.26,jacdac-joystick=github:microsoft/pxt-jacdac/joystick#v0.7.26\"},\"type\":\"renderblocks\",\"id\":\"0e1d5744d84429e5495dfd8718c8e437\"},\"url\":\"/images/makecode/0e1d5744d84429e5495dfd8718c8e437.png\"}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-projects-joystick-2-mouse-mdx-3632589b1c7121970039.js.map