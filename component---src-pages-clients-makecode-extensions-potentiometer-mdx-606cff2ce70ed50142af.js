...
function MDXContent(_ref) {
  ...
  return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    parentName: "p"
  }, "position"), " method returns the current position of the potentiometer."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "As is the case with all sensors, an event handler is supplied for when\nthe sensor value (position) changes by a specified amount."), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("p", null, "The program below use the two potentiometer APIs to print\nthe current position whenever it changes by 5:"), (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("pre", null, (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__.mdx)("code", {
    parentName: "pre",
    "className": "language-blocks"
  }, "{\"source\":\"modules.potentiometer1.onPositionChangedBy(5, function() {\\n    basic.showNumber(modules.potentiometer1.position())\\n})\",\"rendered\":{\"req\":{\"code\":\"modules.potentiometer1.onPositionChangedBy(5, function() {\\n    basic.showNumber(modules.potentiometer1.position())\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac=github:microsoft/pxt-jacdac,jacdac-potentiometer=github:microsoft/pxt-jacdac/potentiometer\"},\"type\":\"renderblocks\",\"id\":\"94f27205a53ddb0cf1ab8dcb9b936895\"},\"url\":\"/images/makecode/94f27205a53ddb0cf1ab8dcb9b936895.png\",\"width\":485,\"height\":128}}\n")));
}
;
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-potentiometer-mdx-606cff2ce70ed50142af.js.map